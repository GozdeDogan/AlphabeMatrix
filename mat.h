...
private:
    ...
    int maxr, maxc;
    double **m;             // the data
    string name;       // the name of the matrix or ""

private:  // private methods
    void allocate(int r, int c, string namex, bool isSubMatrix=false);
    bool deallocate();
    void reallocate(int othermaxr, int othermaxc, string namex);

// constructors
public:
    Matrix(string namex="");
    Matrix(int r, string namex="");                            // create a subMatrix columns unallocated
    Matrix(int r, int c, string namex="");
    Matrix(int r, int c, double initValue, string namex="");   // create and initialize
    Matrix(int r, int c, double *data, string namex="");       // create and initialize from array
    Matrix(const Matrix &other, string namex="");              // copy constructor
...
public:
    void checkBounds(int r, int c, string msg) const;
    void assertColVector(string) const;
    void assertColsEqual(const Matrix &other, string msg) const;
    void assertDefined(string msg) const;
    void assertIndexOK(int, int, string) const;
    void assertOtherLhs(const Matrix &other, string msg) const;
    void assertOtherSizeMatch(const Matrix &other, string msg) const;
    void assertRowVector(string) const;
    void assertRowsEqual(const Matrix &other, string msg) const;
    void assertSize(int r, int c, string msg) const;
    void assertUsableSize(string msg) const;
    void assertSquare(string msg) const;
...
public: 
    ...
    void setName(string newName);   // set matrix name
    const string &getName(const string &defaultName="") const;
...
public: 
    ...
    // input/output
    void print(string msg="") const;      // print matrix and its name
    void printInt(string msg="") const;   // print matrix as integers (it will error if not.)
    void printSize(string msg="") const;  // print just the matrix size
...
private:
    ...
    Matrix readAudio(string filename, string namex);

public: 
////////////////////// BURASI SES DOSYALARI OKUMA FONKSIYONLARI ILE DEGISECEK /////////////////////////////////////////////////////
    Matrix readAudioWav(string filename, string namex);   // read a wav  
    void writeAudioWav(string filename, string comment);  // write a wav
};
